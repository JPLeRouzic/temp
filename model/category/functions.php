...
function get_posts_in_category(string $category, int $page, int $perpage): array {
    ...
    $globpath = 'content/users/*/blog/' . $category . '/post/*.md' ;
    ...
    if (empty($tmp)) {
        not_found('There is no posts in this category');
    }
...
// Return category count. Matching $category.
function get_categorycount(string $category) {
    $globpath = 'content/users/*/blog/' . $category . '/post/*.md' ;
