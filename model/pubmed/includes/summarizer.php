...
class Summarizer {
     ...
     * $end - how much before end, we end summary
     */
    function summary($text, $start, $end, $percent = 1, $min_sentences = 5, $max_sentences = 8) {
        ...
        // Copy the first sentences to the end result
        ...
        // Reincorporate the missing sentences at end
        for($idx = $endsum; $idx < count($sentences); $idx++) {
            $summary_sentences[] = $sentences[$idx];            
        }
