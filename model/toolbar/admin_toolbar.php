...
function toolbar() {
    ...
    $base = site_url();
    echo<<<EOF
    <link href="{$base}views/admin/views/css/toolbar.css" rel="stylesheet" />
EOF
    ;
    echo '<div id="toolbar"><ul>';
    if ($role === 'superadmin') {
        echo '<li><a href="' . $base . 'admin/phpinfo">PHP info</a></li>';
        echo '<li><a href="' . $base . 'admin/logsparser">Logs parser</a></li>';
    ...
    if (($role === 'superadmin') || ($role === 'admin')) {
        ...
        echo '<li><a href="' . $base . 'admin">Mine</a></li>';
        echo '<li><a href="' . $base . '../en/PubmedSys/">Auto Pub</a></li>';
        ...
        echo '<li><a href="' . $base . 'admin/commenti">Comments</a></li>';
    }
