...
// Add static page
function add_page(string $user, Title $title, string $url, string $content, Desc $description1 = null) {
    ...
    if (isset($_SESSION[config("site.url")]['user'])) {
        ...
        if (!empty($posts)) {
            ...
            foreach ($posts as $p) {
                ...
                echo '<td><a href="' . $p->url . '/edit?destination=admin">Edit</a> '
                       . '<a href="' . $p->url . '/delete?destination=admin">Delete</a></td>';
                echo '</tr>';
